...
object PrintCharArray : LibraryFunction {

    override val label = "p_print_char_array"
    ...
    override fun generatex86() =
        listOf(
            ...
            SUBInstr(Register.R0, Register.R0, NumOp(4)),
            MOVInstr(Register.R0, MemAddr(Register.R0)),
            PUSHInstr(Register.R0),
            LDRInstr(Register.R0, LabelOp(msgIndex!!)),
            Syscall("printf"),
            ADDInstr(
                Register.SP,
                Register.SP,
                NumOp(2 * ArmConstants.NUM_BYTE_ADDRESS)
            ),
            MOVInstr(Register.R0, NumOp(0)),
            Syscall("fflush"),
            FunctionEnd()
